...
def test_salary_validation_no_salary() -> None:
    """Тест валидации зарплаты, когда зарплата не указана"""
    vacancy = Vacancy(
        title="Python Developer", url="https://example.com", salary=None, description="Разработка на Python"
    )

    assert vacancy.salary == {"from": 0, "to": 0, "currency": "не указана"}


def test_salary_validation_partial_salary() -> None:
...
def test_salary_validation_from_greater_than_to() -> None:
