...
def test_json_saver_init_creates_file_if_not_exists():
...
def test_json_saver_init_does_not_create_file_if_exists():
...
def test_add_vacancy_new(sample_vacancy, mock_json_file):
...
def test_add_vacancy_duplicate(sample_vacancy, mock_json_file):
...
def test_get_vacancies(sample_vacancy_dict, mock_json_file):
...
def test_delete_vacancy(sample_vacancy, mock_json_file):
...
def test_safe_from_api(sample_vacancy_dict):
...
def test_safe_from_api_with_duplicates(sample_vacancy_dict, mock_json_file):
